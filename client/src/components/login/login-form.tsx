            ...
            <div className="grid gap-6">
                ...
                <>
                    <div className="relative">
                        ...
                        after:border-t after:border-border w-16"
                            ></div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-black">
                        <Button
                            variant="outline"
                            className="flex items-center gap-2 h-12 border-gray-200 hover:bg-gray-50 hover:text-gray-900 rounded-lg bg-white/80 shadow-none cursor-pointer"
                        >
                        ...
                        <Button
                            variant="outline"
                            className="flex items-center gap-2 h-12 border-gray-200 hover:bg-gray-50 hover:text-gray-900 rounded-lg bg-white/60 shadow-none cursor-pointer"
                        >
